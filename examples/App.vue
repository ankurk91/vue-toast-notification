<template>
  <div>
    <nav
      class="navbar navbar-expand-lg navbar navbar-light bg-white shadow-sm mb-3"
    >
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a
            class="nav-link"
            href="https://github.com/ankurk91/vue-toast-notification"
            target="_blank"
          >
            GitHub</a
          >
          ...
          <div class="card">
            <form class="card-body" method="post" @submit.prevent="show">
              ...
              <div class="form-group">
                <label
                  >Duration
                  <code>({{ form.duration / 1000 }} seconds)</code></label
                >
                <input
                  type="range"
                  class="custom-range"
                  ...
                  <div class="form-group">
                    ...
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="checkbox-queue"
                      />
                      <label class="custom-control-label" for="checkbox-queue"
                        >Wait for previous to close before showing new</label
                      >
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul>
                ...
                <li>
                  <a
                    href="https://www.npmjs.com/package/vue-toast-notification"
                    target="_blank"
                    >npm</a
                  >
                </li>
